 ...
 * @LastEditors: Rao
 * @LastEditTime: 2021-05-27 10:13:31
 * @Description: 
 */
...
export default class HeroInfoScene extends GameComponent {
    ...
    onLoad () {
        ...
        // 使用follow时是Adventure在跟着hero移动，并且还是往下移动。Main Camera是不动的。
    ...
    onDisable() {
        ...
        this.uiNodes['_btnReturn'].off('click', this.closeInfo, this);
    }
